...
const ProjectCardsGrid = ({ grid, hideFilter, filterPosition }) => {
  React.useEffect(() => {
    setTimeout(() => {
      initIsotope();
    }, 1000);
          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8 col-md-10'>
              <div className='sec-head text-center'>
                ...
                <h3 className='wow color-font'>Collection of Projects</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={'container'}>
        <div className='row'>
          {!hideFilter && (
            <div
              className={`filtering ${
                filterPosition === 'center' ? 'text-center' : filterPosition === 'left' ? 'text-left' : 'text-right'
              } col-12`}
            >
